...
Class Login extends Controller{
	    ...
	    public function AgregarCuenta(){
	   		if(isset($_POST['Usuario']) && isset($_POST['contraseña']) 
				...
				header('refresh:0;'.URL.'Login/iniciarSesion');//se ejecute en el modelo esta funcion
			}else{
				header('refresh:0;'.URL.'Funcionario/mostrar');;
			}
	    }
