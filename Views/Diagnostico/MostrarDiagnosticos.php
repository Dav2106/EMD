...
if(!isset($_SESSION['idLastDgn'])){
	header('refres:0;'.URL.'Diagnostico/mostrarDia');
}
$fecha = getdate();
					...
					<form name="Diagnostico" method="POST" action="<?php echo URL;?>Diagnostico/ModificarDiagnostico">
						<div class="container">
						    ...
						    <div class="form-group row">
							  	<label for="example-text-input" class="col-xs-1 col-form-label">Diagnóstico:</label>
							  	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-7">
							  		<textarea class="form-control" rows="8" id="Descripcion" name="Descripcion" required maxlength="300" value=""></textarea>
							  	</div>
							</div>
							<input style="display: none;" type="text" id="idFun" name="idFun" value="<?php echo $_SESSION['funcionario'];?>">
							<input style="display: none;" type="text" id="idPac" name="idPac" value="<?php echo $_SESSION['cedula'];?>">
